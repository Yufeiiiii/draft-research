...
def plot_panel(ax, scatter_df, x_col, curve_path, title, xlabel, xlim_max):
    ...
    ax.fill_between(
        curve_df["overall"],
        curve_df["value_floor_5pct"],
        curve_df["value_ceiling_95pct"],
        color="#4f8fc0",
        alpha=0.3,
    ...
    ax.set_ylabel("Expected Draft Value (Scaled)")
...
def main():
    ...
    plot_panel(
        ...
        x_col="Selection",
        curve_path=PROJECT_DIR
        / "results"
        / "gp_sum"
        / "draft_curve_gp_sum_lookup_extended_224.csv",
        title="GP",
    ...
    plot_panel(
        ...
        / "results"
        / "ps_sum"
        / "draft_curve_ps_sum_lookup_extended_224.csv",
        title="PS",
        xlabel="Draft Pick (Selection)",
        xlim_max=224,
    )
    ...
    output_path = PROJECT_DIR / "results" / "draft_curve_faceted_extended_224.png"
